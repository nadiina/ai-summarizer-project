...
## Зміст
1. [Встановлення та запуск](#встановлення)
2. [Приклади використання](#Запуск-та-використання)
...
<p align="center">
  <img src="img_1.png" alt="CLI modes example" width="600">
</p>
...
<p align="center">
  <img src="img_3.png" alt="Web interface upload" width="600">
</p>

Отриманий результат:

<p align="center">
  <img src="img_4.png" alt="Web interface result" width="600">
</p>
...
<p align="center">
  <img src="img_2.png" alt="API post example" width="600">
</p>
...
<p align="center">
  <img src="img_5.png" alt="Telegram bot usage" width="600">
</p>
...
Формат: РІК-МІСЯЦЬ-ДЕНЬ ГГ:ХХ:СС [РІВЕНЬ] Logger: Повідомлення

### Логи взаємодії з LLM (*.jsonl)
